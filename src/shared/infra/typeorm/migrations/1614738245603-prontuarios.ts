...
export default class prontuarios1614738245603 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropForeignKey(
      'prontuarios',
      'fk_prontuario_encaminhado_por',
    );
    await queryRunner.dropForeignKey(
      'prontuarios',
      'fk_prontuario_entrevistado_por',
    );
    await queryRunner.dropForeignKey(
      'prontuarios',
      'fk_prontuario_orcamento_familiar',
    );
    await queryRunner.dropForeignKey('prontuarios', 'fk_prontuario_habitacao');
    await queryRunner.dropForeignKey(
      'prontuarios',
      'fk_prontuario_bens_imoveis',
    );
    await queryRunner.dropForeignKey(
      'prontuarios',
      'fk_prontuario_bens_moveis',
    );
